...
public class MedianOfSorted {
    ...
    public double findMedian(int[] nums1, int[] nums2) {
        int N1 = nums1.length;
        int N2 = nums2.length;
        if (N1 < N2) return findMedian(nums2, nums1);	// Make sure A2 is the shorter one.
    ...
    public static void main(String[] args) {
        System.out.println(new MedianOfSorted().findMedian(new int[]{1,2,3,4,5}, new int[]{6,7,9}));
    }
}
